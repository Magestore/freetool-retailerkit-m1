 ...
 */
class Magestore_Retailerkittools_Block_Purchaseorder extends Mage_Customer_Block_Address_Edit
{
    ...
    public function getCountryHtmlSelectForVendor($defValue=null, $name='vendor[country]', $id='vendor_country', $title='Country')
    {
        Varien_Profiler::start('TEST: '.__METHOD__);
        if (is_null($defValue)) {
            $defValue = $this->getCountryId();
    ...
    public function getVendors(){
        $vendorsCollection = Mage::getModel('retailerkittools/vendor')->getCollection();
        $vendors = array();
        foreach ($vendorsCollection as $key=>$vendor) {
            $vendors[$key] = array(
